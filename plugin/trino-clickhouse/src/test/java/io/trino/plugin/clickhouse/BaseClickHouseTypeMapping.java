        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testMap()
    {
        ...
        SqlDataTypeTest.create()
                ...
                // TODO: insert doesn't respect the session property telling it to use VARCHAR instead of VARBINARY
                //  .addRoundTrip("Map(Int32, FixedString(4))", "MAP(ARRAY[42], ARRAY[VARBINARY ''])", mapWithValueType(VARCHAR), "MAP(ARRAY[42], ARRAY[CAST('nine' AS VARCHAR)])")
                //  .addRoundTrip("Map(Int32, String)", "MAP(ARRAY[42], ARRAY[CAST('ten' AS VARCHAR)])", mapWithValueType(VARCHAR))
                ...
                .execute(getQueryRunner(), mapStringAsVarcharSession(), clickhouseCreateAndTrinoInsert("tpch.test_map"));
    }
