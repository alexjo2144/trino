...
import io.trino.plugin.hive.s3select.S3SelectPageSourceProvider;
        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        pageSourceFactoryBinder.addBinding().to(S3SelectPageSourceProvider.class).in(Scopes.SINGLETON);
