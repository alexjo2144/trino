...
import static io.trino.plugin.iceberg.IcebergSessionProperties.getParquetMaxRowGroupRowCount;
            ...
            HdfsContext hdfsContext)
    {
        ...
        try {
            ...
            ParquetWriterOptions parquetWriterOptions = ParquetWriterOptions.builder()
                    ...
                    .setRowGroupMaxRowCount(getParquetMaxRowGroupRowCount(session))
                    .build();
