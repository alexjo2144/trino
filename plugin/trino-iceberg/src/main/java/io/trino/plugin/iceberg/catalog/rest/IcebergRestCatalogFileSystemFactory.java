...
import static io.trino.filesystem.s3.S3FileSystemFactory.EXTRA_CREDENTIALS_ACCESS_KEY_PROPERTY;
import static io.trino.filesystem.s3.S3FileSystemFactory.EXTRA_CREDENTIALS_SECRET_KEY_PROPERTY;
import static io.trino.filesystem.s3.S3FileSystemFactory.EXTRA_CREDENTIALS_SESSION_TOKEN_PROPERTY;
        ...
        implements IcebergFileSystemFactory
{
    ...
    @Inject
    public IcebergRestCatalogFileSystemFactory(S3FileSystemFactory fileSystemFactory)
    {
