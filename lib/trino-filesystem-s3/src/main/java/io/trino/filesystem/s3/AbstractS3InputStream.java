...
abstract class AbstractS3InputStream<R extends SdkResponse>
        extends TrinoInputStream
{
    ...
    private ResponseInputStream<R> in;
    private long streamPosition;
    private long nextReadPosition;

    public AbstractS3InputStream(Location location, Long length)
    {
        this.location = requireNonNull(location, "location is null");
        this.length = length;
    }

    abstract ResponseInputStream<R> inputStreamFor(long nextReadPosition);
            ...
            throws IOException
    {
        ...
        try {
            in = inputStreamFor(nextReadPosition);
            streamPosition = nextReadPosition;
        }
