...
record S3Context(int partSize, boolean requesterPays, S3SseType sseType, String sseKmsKeyId, AwsCredentialsProvider awsCredentialsProvider)
{
    ...
    public S3Context
    {
        ...
        requireNonNull(awsCredentialsProvider, "awsCredentialProvider is null");
    }
